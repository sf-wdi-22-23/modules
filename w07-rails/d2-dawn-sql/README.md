...
<!-- maybe move this down to avoid distracting them from the focus on raw SQL? -->
...
<!-- Are we doing this in drills or another module? There is a markdown file we can use for this -->
<!-- https://github.com/sf-wdi-21/notes/blob/master/week-07/day-02-sql/dawn-intro-sql/joins.md -->
## Coming soon... Joins
